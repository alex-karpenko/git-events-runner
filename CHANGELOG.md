...
### Details
#### Fixed
- Update mkdocs dependencies by @alex-karpenko in [#74](https://github.com/alex-karpenko/git-events-runner/pull/74)
- Update dependencies to fix knows vulnerabilities by @alex-karpenko in [#76](https://github.com/alex-karpenko/git-events-runner/pull/76)

## [0.4.12] - 2026-03-27
### Details
#### Fixed
- Update dependencies to fix knows vulnerabilities by @alex-karpenko in [#73](https://github.com/alex-karpenko/git-events-runner/pull/73)

## [0.4.11] - 2026-03-13
### Details
#### Fixed
- Update dependencies to fix knows vulnerabilities by @alex-karpenko in [#70](https://github.com/alex-karpenko/git-events-runner/pull/70)

## [0.4.10] - 2026-02-13
### Details
#### Fixed
- Update vulnerable dependencies by @alex-karpenko in [#68](https://github.com/alex-karpenko/git-events-runner/pull/68)

## [0.4.9] - 2026-01-17
### Details
#### Changed
- Maintenance release to fix vulnerable and outdated dependencies by @alex-karpenko in [#66](https://github.com/alex-karpenko/git-events-runner/pull/66)

## [0.4.8] - 2025-10-31
### Details
#### Fixed
- Update dependencies to fix known vulnerabilities by @alex-karpenko in [#63](https://github.com/alex-karpenko/git-events-runner/pull/63)
...
[0.4.10]: https://github.com/alex-karpenko/git-events-runner/compare/v0.4.9..v0.4.10
[0.4.9]: https://github.com/alex-karpenko/git-events-runner/compare/v0.4.8..v0.4.9
